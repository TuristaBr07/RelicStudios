...
function Hero({ onCTA }) {
  return (
    <section aria-label="Destaque principal" style={{
      ...
      <div className="container grid-hero" style={{ position: "relative", padding: "72px 48px 80px", minHeight: 520 }}>
        <div>
          <div style={{
          ...
          <h1 style={{
            ...
            Cada figura é{" "}
            {/* Gradiente escuro: razão mínima 6:1 em todo o range, passa WCAG AA */}
            <span style={{
          ...
          <div style={{
            ...
            <span aria-hidden="true" style={{ width: 40, height: 1, background: "linear-gradient(90deg, transparent, #6E2A06)" }}/>
            <span style={{
              fontFamily: '"Archivo Black", "Bebas Neue", sans-serif',
              letterSpacing: "0.24em", fontSize: 14, textTransform: "uppercase",
              color: "#6E2A06",
            }}>Get The Relic.</span>
            <span aria-hidden="true" style={{ width: 40, height: 1, background: "linear-gradient(90deg, #6E2A06, transparent)" }}/>
          </div>
          <p style={{
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 32, flexWrap: "wrap" }}>
            <button onClick={onCTA} style={{
              ...
              border: "1px solid #B03808", borderTopColor: "#FFEC00",
              borderRadius: 3, cursor: "pointer",
              display: "inline-flex", alignItems: "center", gap: 12, lineHeight: 1,
              boxShadow: [
                "inset 0 1px 0 rgba(255,253,210,0.95)", "inset 0 -1px 0 rgba(176,56,8,0.65)",
                "inset 0 -12px 22px rgba(255,120,20,0.45)",
                "0 2px 0 #8C2A04", "0 8px 18px rgba(60,16,0,0.55)",
                "0 0 0 1px rgba(255,200,80,0.35)", "0 0 24px -2px rgba(255,180,0,0.7)",
              ...
              <span aria-hidden="true" style={{ position: "relative", fontSize: 18 }}>→</span>
            </button>
            <button style={{
              fontFamily: '"Bebas Neue", Impact, sans-serif',
          ...
          <div role="status" aria-live="polite" style={{
            ...
            border: "1px solid #C42A0A", borderRadius: 2,
            background: "rgba(255,90,20,0.12)",
          }}>
            <span aria-hidden="true" style={{ width: 8, height: 8, borderRadius: 999, background: "#C42A0A",
        ...
        <div aria-hidden="true" style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
          <div style={{
      ...
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          ...
          @keyframes relicShine { 0%,100% { transform: translateX(-220%) skewX(-22deg); } }
        }
      `}</style>
    </section>
  );
...
function CategoryStrip({ onPick }) {
  ...
  return (
    <section aria-label="Categorias" style={{ padding: "56px 0", borderBottom: "1px solid var(--line)" }}>
      <div className="container">
        <SectionHeading eyebrow="Mapa do tesouro" title="Onde caçar" />
        <div className="grid-categories" style={{ marginTop: 24 }}>
          {cats.map(c => (
            <button key={c.id} onClick={() => onPick(c.id)}
                    aria-label={`${c.label} — ${c.count} peças`}
                    style={{
              ...
              <div style={{
                ...
                <img src={`assets/icons/${c.glyph}.svg`} style={{ width: 28, height: 28 }} alt="" aria-hidden="true" />
              </div>
              <div>
                <div style={{
                  fontFamily: '"Bebas Neue", Impact, sans-serif',
                  letterSpacing: "0.08em", fontSize: 22, color: "var(--fg)",
                }}>{c.label}</div>
                <div style={{
                  fontFamily: "var(--font-mono)", fontSize: 11,
                  color: "var(--fg-faint)", letterSpacing: "0.06em",
                }} aria-hidden="true">{c.count} PEÇAS</div>
              </div>
              {c.hot && (
                <div aria-hidden="true" style={{
  ...
  return (
    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16 }}>
      <div>
        ...
        <h2 style={{
          fontFamily: '"Bebas Neue", Impact, sans-serif',
          fontSize: 48, lineHeight: 1, letterSpacing: "0.03em", textTransform: "uppercase",
